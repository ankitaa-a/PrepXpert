...
public class QuestionSection3 extends AppCompatActivity {
    ...
    String userans1,userans2,user,userid;
    int yrs;
    TextView displayans;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quesdef3=findViewById(R.id.quesdef3);
        prevbtn=findViewById(R.id.prevbtn3);
        nextbtn=findViewById(R.id.nextbtn3);
        displayans=findViewById(R.id.displaytext3);
        recordbtn=findViewById(R.id.recordbtn3);
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    String ques = snapshot.child(user).child(userid).child("que3").getValue(String.class);
                    quesdef3.setText(ques);
                }
            }
            @Override
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(QuestionSection3.this,QuestionSection4.class);
        ...
        prevbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(QuestionSection3.this,QuestionSection2.class));
            }
        });
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int error) {
                // Handle errors
                Toast.makeText(QuestionSection3.this, "Error: " + error, Toast.LENGTH_SHORT).show();
            }
        ...
        submitbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                userans3=displayans.getText().toString();
                if(!userans3.isEmpty()){
                    Toast.makeText(QuestionSection3.this, "Answer Saved!!", Toast.LENGTH_SHORT).show();
                    submitbtn.setBackgroundColor(getResources().getColor(R.color.white));
                    submitbtn.setEnabled(false);
                }
                else {
                    Toast.makeText(QuestionSection3.this, "Unable to save Answer", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void geminiResp(String query){
        ...
        GeminiResp.getResponse(chatModel, query, new ResponseCallback() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    question3=jsonObject.getString("question");
                    System.out.println(question3);
                    answer3=jsonObject.getString("answer");
                    System.out.println(answer3);
                    quesdef3.setText(question3);
                    //sample.setText(ques);
                } catch (JSONException e) {
                    throw new RuntimeException(e);
                }
            ...
            public void onError(Throwable throwable) {
                quesdef3.setText("Unable to Generate Questions!! Try Again");
            }
        });
    }
