    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(name.isEmpty()){
                    signupName.setError("Name cannot be Void");
                }
...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (validateInputs(name, email, password, username)) {
                    HelperClass helperClass = new HelperClass(name, email, username, password);
                    reference.child(email.replace(".", "_")).setValue(helperClass);
    ...
    private boolean validateInputs(String name, String email, String password, String username) {
        if (name.isEmpty()) {
